...
import {
  LayoutDashboard, AlertTriangle, Users, UserCheck, ClipboardList,
...
const links = [
  ...
  { to: '/admin/responders',  icon: UserCheck,       label: 'Responders' },
        ...
        <div className="p-6 border-b" style={{ borderColor: 'rgba(59,130,246,0.12)' }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-xs text-amber-400">Admin Portal</div>
            </div>
          </div>
        </div>
